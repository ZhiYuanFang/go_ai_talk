...
#### Scenario: 图片帖 thumbnail 为物理 CDN URL

- **WHEN** 列表项含 `mediaKind=1` 且原图 objectKey 为 `social/.../a.jpg`，且 OSS 上已存在 `a_thumb.jpg`
